...
// Sleeper-verified sign-in. The user proves they own a Sleeper account by
// entering the one-time code Sleeper sends to their contact, then we exchange
// that for a Supabase session (handled inside verifySleeperCode).
//
// Two steps:
    ...
    >
      ...
      >
        ...
        <h2 style={{ fontSize: 22, fontWeight: 700, color: "#fff", margin: 0 }}>
          {step === "email" ? "Sign in with Sleeper" : "Enter your code"}
        </h2>
