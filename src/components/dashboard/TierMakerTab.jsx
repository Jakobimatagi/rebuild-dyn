...
// Sleeper headshot with a position-tinted initials fallback — same pattern as
// LiveDraftTab / the admin boards.
function PlayerHeadshot({ playerId, name, position, size = 44 }) {
